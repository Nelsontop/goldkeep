  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="rounded-xl bg-white p-4 shadow-sm">
        ...
        <div className="mt-0.5 text-xs text-stone-400">按最新金价计算</div>
      </div>
      <div className="rounded-xl bg-white p-4 shadow-sm">
        ...
        <div className="mt-0.5 text-xs text-stone-400">{assets.length} 件资产</div>
      </div>
      <div className="rounded-xl bg-white p-4 shadow-sm">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm">
        ...
        <div className={`mt-1 text-xl font-bold ${totalValue >= totalGoldCost ? 'text-red-500' : 'text-green-600'}`}>
          {totalGoldCost > 0
